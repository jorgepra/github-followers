...
class InfoCardController: UIViewController {
    ...
    fileprivate func layoutUI()  {
        ...
        bottomButton.anchor(top: hstack.bottomAnchor, leading: leftItemView.iconImageView.leadingAnchor, bottom: nil, trailing: rightItemView.titleLabel.trailingAnchor, size: .init(width: 0, height: 50))
    }
